...
import ChartData from "../Screens/ChartData";

const useGetCardData = (cryptoName: any, options: any) => {
    return useQuery(
        `${cryptoName}-card`,
        async () => {
...
const CryptoTracker = ( cryptoName: any ) => {
    ...
    var mainCryptoName = cryptoName.cryptoName
    const { data, isLoading } = useGetCardData(mainCryptoName, {
