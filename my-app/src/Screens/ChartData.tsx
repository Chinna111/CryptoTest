...
const useGetChartData = (cryptoName: any, interval: any, options: any) => {

    var finalCryptoName = cryptoName.cryptoName.cryptoName;

    return useQuery(
        ["chartData", interval],
        async () => {
            const response = await fetch(
                `https://api.coingecko.com/api/v3/coins/${finalCryptoName}/market_chart?vs_currency=usd&days=${interval}`
...
const ChartData = ( cryptoName: any, isExpanded: any ) => {
    ...
    //console.log('data', data) // See Updating Data here
